...
let createNewUser = async (data) => {
  ...
  return new Promise(async (resolve, reject) => {
    //dùng Promise đảm bảo luôn trả kết quả, trong xử lý bất đồng
    try {
...
let updateUser = (data) => {
  return new Promise(async (resolve, reject) => {
    //dung Promise đảm bảo luôn trả kết quả, trong xử lý bất đồng bo
    try {
      let user = await db.User.findOne({
...
let deleteUserById = (userId) => {
  return new Promise(async (resolve, reject) => {
    //dung Promise đảm bảo luôn trả kết quả, trong xử lý bất đồng bộ
    try {
      let user = await db.User.findOne({
        where: { id: userId },
      });
